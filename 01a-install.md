...
>> I installed Python 3, since this is the newer version of Python. I had to uninstall my previously-installed version of Anaconda, but then I had to create a new environment for python 3 and activate that.
